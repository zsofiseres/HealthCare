...
public class MainScreenController implements Initializable {
    ...
    /**
     * Canges to patients table scene
     * @param event
     * @throws IOException
     */
    public void changeScreenPatientScreen(ActionEvent event) throws IOException {

        Parent loader = FXMLLoader.load(getClass().getResource("../fxml/PatientsScreen.fxml"));
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        pane.setStyle("-fx-background-image: url(\"/controllers/6.jpg\")");
